    ...
    with torch.no_grad():
        ...
        with tqdm(test_loader, mininterval=5.0, maxinterval=50.0) as it:
            for batch_no, test_batch in enumerate(it, start=1):
                ...
                all_generated_samples_median.append(samples_median.values)
            ...
            all_generated_samples_median = torch.cat(all_generated_samples_median, dim=0)
            ...
            return all_generated_samples_median
