...
def get_data_fix_mask(df_X, train_mask, node_mode=0, split_sample_ratio=0, seed=0, train_edge_prob=0.7, normalize=True, df_y=None):
    if df_y is None:
    ...
    if split_sample_ratio > 0.:
        raise NotImplementedError('split_sample_ratio is not implemented for fix_mask')
